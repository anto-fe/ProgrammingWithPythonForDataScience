...
X = pd.read_csv("../Module5/College.csv", sep=",", index_col=0)
X = pd.DataFrame(X)
#print(X)
...
slice2 = X.Accept
slice3 = X.Enroll.to_frame()
print(type(slice3))

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(slice3, slice2, test_size=0.3, random_state=7)
...
slice2 = X.Accept
slice4 = X[['F.Undergrad']]
print(type(slice4))

from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(slice4, slice2, test_size=0.3, random_state=7)
...
slice2 = X.Accept
slice5 = X[['Room.Board','Enroll']]
print(type(slice5))

from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(slice5, slice2, test_size=0.3, random_state=7)
